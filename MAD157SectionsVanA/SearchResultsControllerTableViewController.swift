        ...
        if let searchString = searchController.searchBar.text {
            ...
            if !searchString.isEmpty {
                let filter: (String) -> Bool = { name in
                    ...
                    if (buttonIndex == SearchResultsControllerTableViewController.shortNamesButtonIndex && nameLength >= SearchResultsControllerTableViewController.longNameSize)
                        ||
                        (buttonIndex == SearchResultsControllerTableViewController.longNamesButtonIndex && nameLength < SearchResultsControllerTableViewController.longNameSize)
                    { return false }
